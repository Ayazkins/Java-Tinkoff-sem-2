...
public class Keys {
    ...
    public static final UniqueKey<ChatLinkRecord> CONSTRAINT_8 = Internal.createUniqueKey(
        ChatLink.CHAT_LINK,
        DSL.name("CONSTRAINT_8"),
        new TableField[] {ChatLink.CHAT_LINK.ID},
        true
    );
    public static final UniqueKey<ChatLinkRecord> CONSTRAINT_8682 = Internal.createUniqueKey(
        ChatLink.CHAT_LINK,
