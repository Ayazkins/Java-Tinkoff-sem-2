...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_CHECKED = createField(DSL.name("LAST_CHECKED"),
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATED = createField(DSL.name("LAST_UPDATED"),
        SQLDataType.TIMESTAMPWITHTIMEZONE(6)
            .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)),
        this,
        ""
